namespace Neutrinodevs.PedidosOnline.Domain.Constants
{
    public static class CString
    {
        ...
        public const string RECIBO_TEMPLATE = "<div style='background-color: #e2e2e2'>	<div style='background-color: white; color: #555; width: 80%; height:600px; margin: 0 auto; border-bottom: 5px solid #000; font-family: Arial, Helvetica, sans-serif;'>		<div style = 'background-color: #000; height:170px; padding:3px; text-align:center;'>			<img src='C:\Users\HP\Desktop\logo-la-pesca.png' width='170' height='170'/>			<h2 style = 'color:#000; text-align:center; margin-top:40px'>Gracias por usar nuestro servicio online.</h2>			<h3>Esperamos que disfrutes tu pedido.</h3>			<section style='padding-top: 15px; padding-left:70px; padding-right:70px;'>				<div style='float:left;'>					<h1 style='color:#000; text-align:left'>TOTAL</h1>					<hr>					<h4 style='color:#000; text-align:left'>SUBTOTAL</h4>					<h4 style='color:#000; text-align:left'>RECARGO DE ENTREGA</h4>					<h4 style='color:#000; text-align:left'>IVA</h4>				</div>				<div style='float:right;'>					<h1 style='color:#000; text-align:right'>$24.30</h1>					<hr>					<h4 style='color:#000; text-align:right'>$20.00</h4>					<h4 style='color:#000; text-align:right'>$0.00</h4>					<h4 style='color:#000; text-align:right'>$2.00</h4>				</div>			</section>		</div>	</div></div>";
    }
}
